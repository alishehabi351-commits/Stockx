...
<?php include "navbar.php";?>
    ...
    <div id="singleImageCarousel" class="carousel slide" data-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
              <a href="#">  <img src="Images/gift guide banner.jpg" class="d-block w-100 singlebanner" alt="Your Image"></a>
            </div>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <h1 class="text-center">Trending tshirts</h1>

            <a href="page2.php" class="text-start"> <button class="hoverbtn text-end"> <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
