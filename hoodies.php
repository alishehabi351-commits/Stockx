...
<?php include_once 'config.php'; ?>
    ...
    <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
           <a href=""> <img src="Images/50 dollar gifts.jpg" class="d-block w-100" alt="First slide"></a>
          </div>
          <div class="carousel-item">
           <a href=""> <img src="Images/Hellstar banner.PNG" class="d-block w-100" alt="Second slide"> </a>
          </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <h1 class="text-center">Trending hoodies</h1>
