...
if ($search !== "") {
  ...
  //  NORMAL CATEGORY VIEW
   ...
   $categories = ['shoes', 'hoodies', 'jackets'];

foreach ($categories as $category) {

    $sql = "SELECT * FROM products WHERE type = ? ORDER BY id ASC LIMIT 8";
    $selectProducts = $conn->prepare($sql);
    $selectProducts->execute([$category]);
    $products = $selectProducts->fetchAll(PDO::FETCH_ASSOC);
...
?>
    ...
    <div class="text-center ">
        ...
        <a href="page2.php" class="round-button">2</a>
